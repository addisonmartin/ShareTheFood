...
RSpec.configure do |config|
  ...
  # Automatically cleans the test database after each test.
  RSpec.configure do |config|
    config.use_transactional_fixtures = false
...
# Enables Shoulda Matchers one-line matchers for use within RSpec tests.
...
# Enables usage of Factory Bot's factories from within RSpec tests.
RSpec.configure do |config|
