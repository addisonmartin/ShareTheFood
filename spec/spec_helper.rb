...
# Enables Capybara's methods within RSpec tests.
require 'capybara/rspec'
# Configures Capybara to use the Puma webserver, same as Rails, and cleans up the test output by making it silent.
