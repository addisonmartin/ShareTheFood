...
Devise.setup do |config|
  ...
  config.secret_key = Rails.application.credentials.password_secret_key
  ...
  config.mailer_sender = 'contact@sharethefood.net'
  ...
  config.pepper = Rails.application.credentials.password_pepper
